...
![Reference root moduli for Fibonacci, plastic, Tribonacci, and Lehmer polynomials.](../One_Wave_Bench/speculative/Nodes/G-723_Spectral_Validation/root_moduli.png)

`One_Wave_Bench/speculative/Nodes/G-723_Spectral_Validation/` stores numerical root, spectral-radius, and Mahler-measure receipts. They are algebraic regression examples, not android safety limits.
