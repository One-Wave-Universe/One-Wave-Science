...
![Fibonacci-word length and branch-count ratios converge toward the golden ratio.](../One_Wave_Bench/speculative/Nodes/G-721a_Validation/fibonacci_word_convergence.png)
...
The directory `One_Wave_Bench/speculative/Nodes/G-721a_Validation/` contains:
