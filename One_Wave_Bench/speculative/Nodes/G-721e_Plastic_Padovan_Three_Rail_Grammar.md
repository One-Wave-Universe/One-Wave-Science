...
![Plastic-Padovan generation-length ratios converging toward the plastic number.](../One_Wave_Bench/speculative/Nodes/G-721_Sequence_Validation/plastic_padovan_convergence.png)

`One_Wave_Bench/speculative/Nodes/G-721_Sequence_Validation/` stores the exact generation table and validator. The receipt validates the substitution and length recurrence only.
