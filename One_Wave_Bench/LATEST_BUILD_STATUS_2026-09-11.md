...
| Nested balance + movement | Mobility contract | Standard native-controller capability; One-Wave adapter not integrated | Architecture defined | Gyro-fed fast balance loop stays inside calibrated safe envelope while higher layer applies bounded lift/direction target lean |
