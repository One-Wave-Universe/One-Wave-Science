...
python3 "$REPO_ROOT/One_Wave_Bench/bridges/hive-pipe/deepseek_web_bridge.py" --relay-health --mcp-smoke

echo "DEEPSEEK_WEB_RELAY_READY"
echo "worker: bash One_Wave_Bench/bridges/scripts/deepseek_web_worker.sh 'your task'"
