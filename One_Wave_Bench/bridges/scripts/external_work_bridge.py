...
GitHub -> Jetson:
  One_Wave_Bench/bridges/external-work/External_Work/inbox/ -> ~/One-Wave-External-Work/inbox/

Jetson -> GitHub staging:
  ~/One-Wave-External-Work/outbox/ -> One_Wave_Bench/bridges/external-work/External_Work/outbox/
...
REPO_INBOX = BRIDGE_ROOT / "external-work" / "External_Work" / "inbox"
REPO_OUTBOX = BRIDGE_ROOT / "external-work" / "External_Work" / "outbox"
...
def main() -> int:
    ...
    try:
        ...
        for path in copied:
            print(path)
        print("Review with: git status --short One_Wave_Bench/bridges/external-work/External_Work/outbox")
