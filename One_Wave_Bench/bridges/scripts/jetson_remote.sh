...
Usage:
  JETSON_GATEWAY_URL=https://... JETSON_GATEWAY_TOKEN=... \
    One_Wave_Bench/bridges/scripts/jetson_remote.sh [--cwd PATH] [--timeout SECONDS] -- COMMAND ARG...

Examples:
  One_Wave_Bench/bridges/scripts/jetson_remote.sh -- uname -a
  One_Wave_Bench/bridges/scripts/jetson_remote.sh --cwd "$HOME/One-Wave-Science" -- git status --short
  One_Wave_Bench/bridges/scripts/jetson_remote.sh --cwd "$HOME/One-Wave-External-Work" -- find . -maxdepth 2 -type f
