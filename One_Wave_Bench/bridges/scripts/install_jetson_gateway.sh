...
CANONICAL="$ROOT/One_Wave_Bench/bridges/hive-pipe/install_gateway.sh"
[[ -f "$CANONICAL" ]] || {
...
echo "One_Wave_Bench/bridges/scripts/install_jetson_gateway.sh is now a compatibility entrypoint."
echo "Canonical gateway: One_Wave_Bench/bridges/hive-pipe/install_gateway.sh (MCP terminal parser)."
exec bash "$CANONICAL"
