...
def static_checks() -> list[Check]:
    ...
    required = [
        ...
        "One_Wave_Bench/bridges/hive-pipe/chatgpt_terminal_pull.py",
        "One_Wave_Bench/bridges/hive-pipe/install_chatgpt_terminal_pull.sh",
        "One_Wave_Bench/bridges/hive-pipe/bootstrap_chatgpt_terminal_pull.sh",
    ...
    python_files = [
        "One_Wave_Bench/bridges/hive-pipe/gateway.py",
        "One_Wave_Bench/bridges/hive-pipe/mudl.py",
        "One_Wave_Bench/bridges/hive-pipe/terminal_parser.py",
        "One_Wave_Bench/bridges/hive-pipe/chatgpt_terminal_pull.py",
        "One_Wave_Bench/bridges/hive-pipe/bridge_doctor.py",
        "One_Wave_Bench/bridges/hive-pipe/deepseek_bridge.py",
        "One_Wave_Bench/bridges/hive-pipe/deepseek_web_bridge.py",
        "One_Wave_Bench/bridges/scripts/external_work_bridge.py",
    ]
    ...
    shell_files = [
        "One_Wave_Bench/bridges/hive-pipe/agent.sh",
        "One_Wave_Bench/bridges/hive-pipe/install_gateway.sh",
        "One_Wave_Bench/bridges/hive-pipe/create_client_token.sh",
        "One_Wave_Bench/bridges/hive-pipe/install_chatgpt_terminal_pull.sh",
        "One_Wave_Bench/bridges/hive-pipe/bootstrap_chatgpt_terminal_pull.sh",
        "One_Wave_Bench/bridges/scripts/jetson_remote.sh",
        "One_Wave_Bench/bridges/scripts/install_jetson_gateway.sh",
        "One_Wave_Bench/bridges/scripts/enable_jetson_ssh.sh",
    ]
    ...
    contracts: list[tuple[str, list[str]]] = [
        ...
        ("One_Wave_Bench/bridges/hive-pipe/install_chatgpt_terminal_pull.sh", ["chatgpt-terminal", "chatgpt-terminal-backup"]),
        ("One_Wave_Bench/bridges/hive-pipe/gateway.py", ["terminal_reference", "terminal_run", "python_run", "cpp_compile_run"]),
        ("One_Wave_Bench/bridges/hive-pipe/deepseek_bridge.py", ["terminal_pwd", "terminal_which", "terminal_run"]),
    ]
...
def gateway_live_checks(*, required: bool, timeout: int) -> list[Check]:
    ...
    if not token:
        checks.append(Check(
            ...
            "Run One_Wave_Bench/bridges/hive-pipe/create_client_token.sh codex or set HIVE_PIPE_TOKEN_FILE without exposing the token.",
        ))
        return checks
...
def pull_live_checks(*, required: bool) -> list[Check]:
    ...
    if not (runtime / ".git").is_dir():
        checks.append(Check(
            ...
            "Run One_Wave_Bench/bridges/hive-pipe/install_chatgpt_terminal_pull.sh from the checkout of the machine to control.",
        ))
        return checks
...
def optional_live_checks(timeout: int) -> list[Check]:
    ...
    try:
        ...
        checks.append(Check(
            ...
            NOT_CONFIGURED,
            f"{type(exc).__name__}: {exc}",
            "Only if the free-web adapter is wanted: run One_Wave_Bench/bridges/scripts/bootstrap_deepseek_web_relay.sh and then its relay-health check.",
        ))
