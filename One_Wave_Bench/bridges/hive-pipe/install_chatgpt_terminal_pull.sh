...
ExecStart=/usr/bin/python3 $RUNTIME_ROOT/One_Wave_Bench/bridges/hive-pipe/chatgpt_terminal_pull.py --watch
Restart=always
RestartSec=5
...
for attempt in 1 2 3 4 5; do
  if python3 "$RUNTIME_ROOT/One_Wave_Bench/bridges/hive-pipe/bridge_doctor.py" --profile pull; then
