...
> **Lineage note:** Superseded operationally by `docs/updates/UPDATED_26_MASS_ASSUMPTION_ERASURE.md`. The four-interaction equations below remain part of the current derivation.
