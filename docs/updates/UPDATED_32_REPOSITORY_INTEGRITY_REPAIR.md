...
Detailed machine-readable receipts are stored under `Integrity_Tools/`. The human-readable execution record is `docs/audits/AUDIT_UPDATED_32_REPOSITORY_INTEGRITY_REPAIR.md`.
